...
pfile = pset.ParticleFile(name="/alphadata04/onink/lagrangian_sim/Azores/Output/Seasonality/Azores2014Season",
...
pset.execute(totalKernal,
             runtime=timedelta(days=360),  # runtime controls the interval of the plots
